  ...
  extends ResponseCache
{
  ...
  private static final class Entry
  {
      ...
      throws IOException
    {
      ...
      //   79: dup
      //   80: aload_3
      //   81: invokevirtual 180	java/security/cert/CertificateException:getMessage	()Ljava/lang/String;
      ...
      throws IOException
    {
      ...
      //   98: dup
      //   99: aload_3
      //   100: invokevirtual 208	java/security/cert/CertificateEncodingException:getMessage	()Ljava/lang/String;
      //   103: invokespecial 83	java/io/IOException:<init>	(Ljava/lang/String;)V
      //   106: athrow
      // Local variable table:
      //   start	length	slot	name	signature
      //   0	107	0	this	Entry
      //   0	107	1	paramWriter	Writer
      //   0	107	2	paramArrayOfCertificate	Certificate[]
